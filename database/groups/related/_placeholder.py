...
approach = Group(
    ...
    _meta=[dict(
        ...
        annotations=[], # PARSEABLE x EXECUTABLE, INTERNAL x EXTERNAL, INCLUSIVE x EXCLUSIVE, OPTIONAL, PROVENANCE
        ...
        distribution=[], # INTEROPERABLE, LOGIC_FILE, SHADOW_FILES, GRAPH_FILE, LOG, VCS, PROPRIETARY, REPOSITORY, PACKAGE, CONTENT_DATABASE, SOURCE, NOSQL
        storage=[], # ^ + FILE_SYSTEM, GRAPH_DB, RELATIONAL_DB, KEY_VALUE_DB
