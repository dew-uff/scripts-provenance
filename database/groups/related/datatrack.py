...
approach = Group(
    ...
    _meta=[dict(
        ...
        categories=[COLLECTION, EVOLUTION, MANAGEMENT, VISUALIZATION],
        ...
        cache=NO,
        replay=NO,
        evolution=INTENTION.star("Uses VCS"),
        pipeline=YES,
        ...
        granularity=[USER_DEFINED, OS_VERSION, R_VERSION, MODULES, SOURCE],
        granularity_text="User defined, Parameters, Platform, Modules, Source",
    ...
    _about="""
        ...
        <p class="collection">
            ...
            Such functions receive the file name, a list of dependencies, parameters, and annotations as arguments. Users can use arbritary dependencies and annotations to describe the experiment.
            ...
            Finally, Datatrack also integrates with git to get the source code version and manage the definition provenance.
        </p>
        <p class="storage">
            Datatrack stores provenance and versioning metadata in a CSV file under the project directory.
            It rellies on git to store multiple versions of source and data.
            <span class="evolution"> This way, it supports the evolution of experiments </span>
        </p>
        <p class="analysis">
